...
namespace TicketHive_MadCats.Shared.Models
{
	...
	/// <summary>
	/// Class generated by online converters containing all the 
	/// data in the body of an request to https://api.apilayer.com/exchangerates_data/convert
    /// for converting a single currency to another single currency
	/// </summary>
